    ...
    <!-- _______________________Start of content Area_____________________________-->
      <div id="content">
    	...
    	<form class="register" method="post">
			   ...
			   <select name="formfname" style="width: 40%;" onchange="update(this.value)">
			   ...
			   <select name="formfid" style="width: 40%;" id="data">
			   </select><br><br>
			   
			   <br>
			   <input type="submit" value="Delete Faculty" name="delete" class="register-button" style="margin-left: 160px">
		</form>
...
$fid = $_POST['formfid'];
	...
	{
		echo "<script>";
		echo "alert('Error during delete faculty')";
		echo "</script>";
	}

	$query = "delete from login where id = '$fid'";
	$run = mysqli_query($conn,$query);
