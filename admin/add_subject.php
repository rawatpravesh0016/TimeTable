    ...
    <!-- _______________________Start of content Area_____________________________-->
      <div id="content" style=" height:400px">
    	...
    	<form class="register" method="post">
			   ...
			   <input type="submit" value="Add Subject" name="add" class="register-button" style="margin-left: 160px">
		</form>
...
$query = "insert into subject values ('$scode','$sname')";

if( !mysqli_query($conn,$query) )
{
  echo "<script>";
  echo "alert('Error during add Subject.')";
  echo "</script>";
}
else
{
	echo "<script>";
	echo "alert('Subject inserted successfully.')";
	echo "</script>";
}
