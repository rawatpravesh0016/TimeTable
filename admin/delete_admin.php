    ...
    <head>
        ...
        <script type="text/javascript">
			   function update(str)
			   {
			      ...
			      xmlhttp.open("GET","get_aid.php?opt="+str, true);
			      xmlhttp.send();
			  }
    ...
    <!-- _______________________Start of content Area_____________________________-->
      <div id="content">
    	...
    	<form class="register" method="post">
			   ...
			   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			   Select Faculty Name<sup>*</sup> : &nbsp;&nbsp;
			   <select name="formaname" style="width: 40%;" onchange="update(this.value)">
			   ...
			   <select name="formaid" style="width: 40%;" id="data">
			   </select><br><br>
			   
			   <br>
			   <input type="submit" value="Delete Admin" name="delete" class="register-button" style="margin-left: 160px">
		</form>
...
$aid = $_POST['formaid'];
	...
	{
		echo "<script>";
		echo "alert('Error during delete Admin')";
		echo "</script>";
	}

	$query = "delete from login where id = '$aid'";
	$run = mysqli_query($conn,$query);
