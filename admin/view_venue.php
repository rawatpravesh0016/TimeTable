...
<html>
    ...
    <!-- _______________________Start of content Area_____________________________-->
      <div id="content">
    	...
    	<form class="register" method="post" action="viewbyvenue.php" target="_blank">
			   ...
			   <br><br><br>
			   <input type="submit" value="See Schedule" name="svenue" class="register-button" style="margin-left: 160px">
		</form>
