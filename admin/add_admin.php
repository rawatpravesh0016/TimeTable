...
<html>
    ...
    <div id="content" style=" height:850px">
    	...
    	<form class="register" method="post">
    		 ...
    		 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			   Admin ID<sup>*</sup>(at MAX 5 characters)
			   ...
			   <input type="submit" value="Add Admin" name="add" class="register-button" style="margin-left: 160px">
		  </form>  
    </div>
...
$query = "insert into admin values ('$fid','$fname','$mail','$contact','$pass','$squs','$sans')";
