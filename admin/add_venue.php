    ...
    <!-- _______________________Start of content Area_____________________________-->
      <div id="content">
    	...
    	<form class="register" method="post">
			   ...
			   <input type="submit" value="Add Venue" name="add" class="register-button" style="margin-left: 160px">
		</form>
...
$query = "insert into venue values ('$vname')";

if( !mysqli_query($conn,$query) )
{
  echo "<script>";
  echo "alert('Error during add Venue.')";
  echo "</script>";
}
else
{
	echo "<script>";
	echo "alert('Venue inserted successfully.')";
	echo "</script>";
}
