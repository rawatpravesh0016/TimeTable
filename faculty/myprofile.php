...
<html>
    ...
    <!-- _______________________Start of content Area_____________________________-->
      <div id="content">
	       ...
	       <form class="register" method="post" action="updateprofile.php">
	       	<b style="font-size: 16px;" >
	       		<?php  getfdetail($_SESSION['fid']); ?>
	        </b>
	        <input type="submit" value="Edit Profile" name="schedule" class="register-button" style="margin-left: 160px">
	       </form>
      </div>
